...
$.get(ROOT_PATH + '/data/asset/geo/USA.json', function (usaJson) {
  ...
  option = {
    title: {
      ...
      subtext: 'Data as of: Thursday, October 20, 2022 9:23 PM ET. \nQuestion: What is the situation of the COVID-19 death in all states of the United States? ',
      left: 'left'
    },
    tooltip: {
      trigger: 'item',
